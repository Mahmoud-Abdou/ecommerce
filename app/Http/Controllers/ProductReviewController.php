...
class ProductReviewController extends Controller
{
  ...
  */
    ...
    public function __construct(ProductReviewRepository $productReviewRepo, CustomFieldRepository $customFieldRepo, UserRepository $userRepo, ProductRepository $productRepo)
    {
        parent::__construct();
    ...
    public function edit($id)
    {
        ...
        $product = $this->productRepository
            ->join('product_translates', 'product_translates.product_id', 'products.id')
                ->pluck('product_translates.name', 'products.id');
        ...
        ->with('productReview', $productReview)
