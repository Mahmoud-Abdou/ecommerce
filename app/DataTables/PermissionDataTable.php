...
class PermissionDataTable extends DataTable
{
    ...
    protected function getColumns()
    {
        ...
        foreach ($roles as $role){
            $newColumn['data'] = 'name';
            // $newColumn['data_id'] = 'id';
            $newColumn['title'] = trans('lang.'.$role->name);
            $newColumn['searchable'] = 'false';
            $newColumn['exportable'] = 'false';
            $newColumn['printable'] = 'false';
            // $newColumn['render'] = 'function(){return "<div class=\'checkbox icheck\'><label><input  type=\'checkbox\' name=\'"+data+ "\' class=\'permission\' data-role-id=\''.$role->id.'\' data-permission=\'"+data+"\'></label></div>"}';
            $columns[] = $newColumn;
        }
        return $columns;
    }
