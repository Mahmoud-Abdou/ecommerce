...
<div style="flex: 50%;max-width: 50%;padding: 0 4px;" class="column">
    ...
    <div class="form-group row ">
        ...
        <div class="col-9">
            {!! Form::number('tax', null,  ['class' => 'form-control','placeholder'=>  trans("lang.order_tax_placeholder"), "disabled"=>"true"]) !!}
    ...
    <div class="form-group row ">
        ...
        <div class="col-9">
            {!! Form::number('delivery_fee', null,  ['class' => 'form-control','placeholder'=>  trans("lang.order_delivery_fee_placeholder"), "disabled"=>"true"]) !!}
            <div class="form-text text-muted">
