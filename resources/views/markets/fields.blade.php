...
<div style="flex: 50%;max-width: 50%;padding: 0 4px;" class="column">
    ...
    <div class="form-group row ">
        ...
        <div class="col-9">
            {!! Form::number('default_tax', null,  ['class' => 'form-control', 'step'=>'any','placeholder'=>  trans("lang.market_default_tax_placeholder"), "min"=>"0", "max"=>"100"]) !!}
            <div class="form-text text-muted">
      ...
      @prepend('scripts')
        <script type="text/javascript">
            ...
            var dz_var15671147171873255749ble = $(".dropzone.image").dropzone({
                    ...
                    init: function () {
                        @if(isset($market) && $market->hasMedia('image'))
                        dzInit(this, var15671147171873255749ble, '{!! url($market->getFirstMediaUrl('image','thumb')) !!}')
                        @endif
                    },
                    ...
                    removedfile: function (file) {
                        dzRemoveFile(
                            file, var15671147171873255749ble, '{!! url("market/remove-media") !!}',
