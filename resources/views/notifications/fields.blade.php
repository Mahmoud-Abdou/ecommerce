...
<!-- Description Field -->
<div class="form-group row ">
  {!! Form::label('data', trans("lang.notification_data"), ['class' => 'col-3 control-label text-right']) !!}
  <div class="col-9">
    {!! Form::text('data', null, ['class' => 'form-control','placeholder'=>
     trans("lang.notification_data_placeholder")  ]) !!}
    <div class="form-text text-muted">{{ trans("notification_data_help") }}</div>
  </div>
</div>
</div>
<div style="flex: 50%;max-width: 50%;padding: 0 4px;" class="column">
...
<div class="form-group row ">
  ...
  <div class="col-9">
    {!! Form::select('user_id',["null"=>"all","-----------"=>$user], null, ['class' => 'select2 form-control']) !!}
