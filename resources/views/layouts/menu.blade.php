...
@can('categories.index')
    ...
    <li class="nav-item has-treeview {{ Request::is('categories*') || Request::is('options*') || Request::is('optionGroups*') || Request::is('productReviews*') || Request::is('nutrition*') ? 'menu-open' : '' }}">
        <a href="#" class="nav-link {{  Request::is('categories*') || Request::is('options*') || Request::is('optionGroups*') || Request::is('productReviews*') || Request::is('nutrition*') ? 'active' : '' }}"> @if($icons)
        ...
        <ul class="nav nav-treeview">
            ...
            @endcan
            @can('category_translation.index')
                <li class="nav-item">
                    <a class="nav-link {{ Request::is('category_translation*') ? 'active' : '' }}" href="{!! route('category_translation.index') !!}">@if($icons)
                            <i class="nav-icon fa fa-folder"></i>@endif<p>{{trans('lang.category_translation')}}</p></a>
                </li>
            @endcan
...
@can('products.index')
    <li class="nav-item has-treeview {{ Request::is('products*') || Request::is('options*') || Request::is('optionGroups*') || Request::is('productReviews*') || Request::is('nutrition*') ? 'menu-open' : '' }}">
        ...
        <ul class="nav nav-treeview">
            ...
            @endcan
            @can('product_translation.index')
                <li class="nav-item">
                    <a class="nav-link {{ Request::is('product_translation*') ? 'active' : '' }}" href="{!! route('product_translation.index') !!}">@if($icons)
                            <i class="nav-icon fa fa-archive"></i>@endif
                        <p>{{trans('lang.product_translation')}}</p></a>
                </li>
            @endcan
...
@can('promoCodes.index')
    <li class="nav-item has-treeview {{Request::is('promoCodes*') ? 'menu-open' : '' }}">
        <a href="#" class="nav-link {{ Request::is('promoCodes*') ? 'active' : '' }}"> @if($icons)
                <i class="nav-icon fa fa-support"></i>@endif
            <p>{{trans('lang.promoCode_plural')}} <i class="right fa fa-angle-left"></i>
            </p>
        </a>
        <ul class="nav nav-treeview">
            @can('promo_codes.index')
                <li class="nav-item">
                    <a class="nav-link {{ Request::is('promoCodes*') ? 'active' : '' }}" href="{!! route('promoCodes.index') !!}">@if($icons)
                            <i class="nav-icon fa fa-question-circle"></i>@endif
                        <p>{{trans('lang.promoCode_plural')}}</p></a>
                </li>
            @endcan
        </ul>
    </li>
